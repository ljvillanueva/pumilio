<form method="GET" action="pumilio.php" style="text-align: center;">
	<input type="text" size="3" id="x" name="t_min" title="Minimum time of selection" class="ui-state-default ui-corner-all" /> -
	 <input type="text" size="3" id="x2" class="ui-state-default ui-corner-all" name="t_max" title="Maximum time of selection" /> sec | 
	<input type="text" size="4" id="y" class="ui-state-default ui-corner-all" name="f_min" title="Minimum frequency of selection" /> - 
	 <input type="text" size="4" id="y2" class="ui-state-default ui-corner-all" name="f_max" title="Maximum frequency of selection" /> Hz<br>

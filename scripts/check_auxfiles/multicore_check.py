...
def newprocess():
	...
	shutil.copy("check_auxfiles.py", this_random_folder)
	shutil.copy("svt.py", this_random_folder)
	return this_random_folder

def runprocess(folder):
	os.chdir(folder)
	p = subprocess.Popen(['python', 'check_auxfiles.py', '1'])
	os.chdir(this_dir)
	return p

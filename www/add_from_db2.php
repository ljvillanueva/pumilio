...
/*
			...
			echo "<input type=\"hidden\" name=\"dir\" value=\"$dir\"><input type=\"hidden\" name=\"ColID\" value=\"$ColID\"><input type=\"hidden\" name=\"files_format\" value=\"$files_format\">
			...
			echo " <input type=submit value=\" Select fields \" class=\"fg-button ui-state-default ui-corner-all\" style=\"font-size:12px\"></form>";

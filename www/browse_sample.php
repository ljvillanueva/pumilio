	...
	<div class="container">
		...
		<div class="span-4">
			...
			if ($startid>1)	{
				...
				echo "<a href=\"browse_sample.php?SampleID=$SampleIDq&startid=$go_to&order_by=$order_by&order_dir=$order_dir&display_type=$display_type\"><img src=\"images/arrowleft.png\"></a> ";
				}
			...
			if ($endid_show<$no_sounds) {
				$go_to=$startid+$how_many_to_show;
				echo "<a href=\"browse_sample.php?SampleID=$SampleIDq&startid=$go_to&order_by=$order_by&order_dir=$order_dir&display_type=$display_type\"><img src=\"images/arrowright.png\"></a> ";
				}
			?>
		</div>
		<div class="span-3">
			...
			echo "<a href=\"browse_sample.php?SampleID=$SampleIDq&order_by=SampleMembersID&order_dir=ASC&display_type=$display_type\">Original order</a>";
		...
		<div class="span-3">
			<?php
			#Order by sound name
			echo "<p>Name <a href=\"browse_sample.php?SampleID=$SampleIDq&order_by=SoundName&order_dir=ASC&display_type=$display_type\"><img src=\"images/arrowdown.png\"></a> <a href=\"browse_sample.php?SampleID=$SampleIDq&order_by=SoundName&order_dir=DESC&display_type=$display_type\"><img src=\"images/arrowup.png\"></a>";
		...
		<div class="span-3">
			<?php
			#Order by sound date
			echo "<p>Date <a href=\"browse_sample.php?SampleID=$SampleIDq&order_by=Date&order_dir=ASC&display_type=$display_type\"><img src=\"images/arrowdown.png\"></a> <a href=\"browse_sample.php?SampleID=$SampleIDq&order_by=Date&order_dir=DESC&display_type=$display_type\"><img src=\"images/arrowup.png\"></a>";

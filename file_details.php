	...
	<div class="container">
		...
		<div class="span-12">
			...
			echo "<h3>File details:</h3>
				<ul>
					<li>File name: $soundfile_name
					<li>File format: $soundfile_format
					<li>File size: $soundfile_size
					<li>Number of channels: $no_channels
					<li>Duration: $soundfile_duration seconds
					<li>Sampling Rate: $soundfile_samplingrateoriginal Hz
				</ul>\n";
			?>
		</div>
		<div class="span-2">
		...
		<div class="span-10 last">
			<?php
				require("processor_view_small.php");
			?>
		</div>
		<div class="span-24 last">
			&nbsp;
